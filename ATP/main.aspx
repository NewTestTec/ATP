        ...
        <f:RegionPanel ID="regionPanel" ShowBorder="false" runat="server">
            <Regions>
                <f:Region ID="regionTop" ShowBorder="false" ShowHeader="false" Position="Top"
                    Layout="Fit" runat="server" Height="130">
                    <Toolbars>
                    ...
                    <Items>
                        <f:Panel runat="server" CssClass="topbar" ShowHeader="false" ShowBorder="false"  BodyPadding="10" Height="40" Layout="fit">
                            <Items>
                                <f:Image ID="logoimg" ImageUrl="~/res/images/banner.jpg" Height="120"></f:Image>
                            </Items>
                        </f:Panel>
                    </Items>
                </f:Region>
