<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReportBug.aspx.cs" Inherits="AppBox.apps.ReportBug.ReportBug" %>
            ...
            <Items>
                <f:Form ID="Form2" runat="server" Height="36px" BodyPadding="5px" ShowHeader="false"
                    ...
                    <Rows>
                        <f:FormRow ID="FormRow1" runat="server">
                            <Items>
                                <f:TwinTriggerBox ID="ttbSearchMessage" runat="server" ShowLabel="false" EmptyText="在缺陷名称中搜索"
                ...
                <f:Grid ID="Grid1" runat="server" BoxFlex="1" ShowBorder="true" ShowHeader="false"
                        ...
                        <f:Toolbar ID="Toolbar1" runat="server">
                            <Items>
                               <%-- <f:Button ID="btnDeleteSelected" Icon="Delete" runat="server" Text="删除选中记录" OnClick="btnDeleteSelected_Click">
                                ...
                                <f:Button ID="btnNew" runat="server" Icon="Add" EnablePostBack="false" Text="新建缺陷">
                                </f:Button>
                            </Items>
                        </f:Toolbar>
                    </Toolbars>
                    ...
                    <Columns>
                        ...
                        <f:BoundField DataField="Name" SortField="Name" Width="100px" HeaderText="脚本名" />
                         <f:BoundField DataField="FileName" SortField="FileName" Width="100px" HeaderText="脚本文件名" />
                        <f:BoundField DataField="Path" SortField="Path" Width="100px" HeaderText="路径" />
                        ...
                        <%--<f:BoundField DataField="Content" ExpandUnusedSpace="true" HeaderText="内容" />--%>
                         <f:BoundField DataField="Language" SortField="Language" ExpandUnusedSpace="true" HeaderText="语言" />
                         <f:BoundField DataField="Creater" SortField="Creater" ExpandUnusedSpace="true" HeaderText="创建者" />
                        ...
                        <f:WindowField TextAlign="Center" Icon="Information" ToolTip="查看详细信息" Title="查看详细信息"
                            WindowID="Window1" DataIFrameUrlFields="ID" DataIFrameUrlFormatString="~/apps/Script/Script_View.aspx?id={0}"
                            Width="50px" />
                        
                        <f:WindowField ColumnID="editField" TextAlign="Center" Icon="Pencil" ToolTip="编辑"
                            WindowID="Window1" Title="编辑" DataIFrameUrlFields="ID" DataIFrameUrlFormatString="~/apps/Script/Script_Edit.aspx?id={0}"
                            Width="50px" />
