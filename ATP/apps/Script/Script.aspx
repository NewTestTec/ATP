<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Script.aspx.cs" Inherits="AppBox.apps.Script.Script" %>
                        ...
                        <f:Toolbar ID="Toolbar1" runat="server">
                            <Items>
                               <%-- <f:Button ID="btnDeleteSelected" Icon="Delete" runat="server" Text="删除选中记录" OnClick="btnDeleteSelected_Click">
                                ...
                                <f:Button ID="btnNew" runat="server" Icon="Add" EnablePostBack="false" Text="新增脚本">
                                </f:Button>
                            </Items>
                        </f:Toolbar>
                    </Toolbars>
