<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Flow.aspx.cs" Inherits="AppBox.apps.Flow.Flow" %>
                ...
                <f:Grid ID="Grid1" runat="server" BoxFlex="1" ShowBorder="true" ShowHeader="false"
                        ...
                        <f:Toolbar ID="Toolbar1" runat="server">
                            <Items>
                               <%-- <f:Button ID="btnDeleteSelected" Icon="Delete" runat="server" Text="删除选中记录" OnClick="btnDeleteSelected_Click">
                                ...
                                <f:Button ID="btnNew" runat="server" Icon="Add" EnablePostBack="false" Text="新增流程">
                                </f:Button>
                               <%-- <f:Button ID="btnAddScript" runat="server" Icon="Add" EnablePostBack="false" Text="编辑对应脚本">
                                </f:Button>--%>
                    ...
                    <Columns>
                        ...
                        <f:WindowField TextAlign="Center" Icon="Information" ToolTip="查看详细信息" Title="查看详细信息"
                            WindowID="Window1" DataIFrameUrlFields="ID" DataIFrameUrlFormatString="~/apps/Flow/Flow_View.aspx?id={0}"
                            Width="50px" />
                        
                        <f:WindowField ColumnID="editField" TextAlign="Center" Icon="Pencil" ToolTip="编辑"
                            WindowID="Window1" Title="编辑" DataIFrameUrlFields="ID" DataIFrameUrlFormatString="~/apps/Flow/Flow_Edit.aspx?id={0}"
                            Width="50px" />
                        <f:LinkButtonField ColumnID="deleteField" TextAlign="Center" Icon="Delete" ToolTip="删除"
                         ...
                         <f:WindowField ColumnID="editField1" TextAlign="Center" Icon="ApplicationEdit" ToolTip="编辑对应脚本"
                            WindowID="Window1" Title="编辑对应脚本" DataIFrameUrlFields="ID" DataIFrameUrlFormatString="~/apps/Flow/FlowScript.aspx?id={0}"
                            Width="50px" />
                    </Columns>
                </f:Grid>
            </Items>
