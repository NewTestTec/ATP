<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Flow_New.aspx.cs" Inherits="AppBox.apps.Flow.Flow_New" %>
                ...
                <f:Form ID="SimpleForm1" ShowBorder="false" ShowHeader="false" runat="server" BodyPadding="10px"
                    ...
                    <Rows>
                        <f:FormRow runat="server">
                            <Items>
                                <f:TextBox ID="tbxName" runat="server" Label="流程名" Required="true" ShowRedStar="true">
                                </f:TextBox>                                
                            </Items>
                        </f:FormRow>
