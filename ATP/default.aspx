    ...
    <form id="form1" runat="server">
        <f:PageManager ID="PageManager1" runat="server"></f:PageManager>
         <f:Window ID="Window1" runat="server" IsModal="true" Hidden="false" EnableClose="false"
            ...
            <Items>
                <f:Image ID="imageLogin" ImageUrl="~/res/images/login/login_4.png" runat="server"
                ...
                <f:SimpleForm ID="SimpleForm1" LabelAlign="Top" BoxFlex="1" runat="server" LabelWidth="45px"
                    ...
                    <Items>
                        <f:TextBox ID="tbxUserName" Width="180" FocusOnPageLoad="true" runat="server" Label="帐号" Required="true"
                            ShowRedStar="true" Text="">
                        </f:TextBox>
                        <f:TextBox ID="tbxPassword" Width="180" TextMode="Password" runat="server" Required="true" ShowRedStar="true"
                            Label="密码" Text="">
                        </f:TextBox>
                    </Items>
                </f:SimpleForm>
